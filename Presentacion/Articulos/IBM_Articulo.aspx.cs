...
namespace Presentacion.Articulos
{
  public partial class IBM_Articulo : System.Web.UI.Page
  {
    ...
    {
      InicializaControles();
      GrvArticulos.DataSource = NA.ListarArticulos();
    ...
    protected void BtnModificar_Click(object sender, EventArgs e)
    {
      ...
      //todo corregir los datos de los parametros
      int ID = Convert.ToInt16(hfIdArticulo.Value);
      E_Articulo EC = new E_Articulo(ID, 1, "001", tbNombreArticulo.Text, tbDescripcionArticulo.Text, 150, 4, true);
