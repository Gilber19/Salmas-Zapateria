<%@ Page Title="Modificar Artículo" Language="C#" MasterPageFile="~/PaginasMaestras/mpConLogueo.master" AutoEventWireup="true" CodeBehind="ModificarArticulo.aspx.cs" Inherits="Presentacion.ModificarArticulo.ModificarArticulo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphConLogueo" runat="server">
    <div class="container my-5">
        ...
        <asp:Panel runat="server">
            <asp:Label
                ID="lblMensaje" runat="server" CssClass="alert" Visible="false"></asp:Label>
            <div class="row">
                <!-- Primera columna -->
                <div class="col-md-4">
                    <!-- Nombre -->
                ...
                <div class="col-md-4">
                    ...
                    <!-- Botón Agregar -->
                    <div class="mb-3">
                        <asp:Button ID="btnModificar" runat="server" Text="Modificar" CssClass="btn btn-success w-100" OnClick="btnModificar_Click" />                    </div>
                </div>
            </div>
        </asp:Panel>
    </div>
