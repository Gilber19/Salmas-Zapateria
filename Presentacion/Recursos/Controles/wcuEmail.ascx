...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="wcuEmail.ascx.cs" Inherits="PAAD.Controles.wcuEmail" %>
...
<link href="../CSS/bootstrap.min.css" rel="stylesheet" type="text/css" />
  ...
  Display="Dynamic" 
  CssClass="text-danger font-weight-normal"><i class="text-danger fas fa-exclamation-triangle mr-2"></i>Parece que no es una dirección de correo electrónico válida.  
</asp:RegularExpressionValidator>
